...
//			header("Location:../index.php?info=out");
//			exit;
//		}
	?>   
    ...
    <?php
		...
		$consultant = "";
			...
			/*else{
				...
				header("Location:../index.php?info=Please Login");
				exit;
			}*/
		session_destroy();
...
<body onLoad="delayLoading();">
	<!--This Div Used for AutoSuggestion by TomTom-->
        ...
        <div id="crmPanel" >
            <div class="crmContent" >
                ...
                <div id="accordion" style="background-color:#FFF">
                    ...
                    -->
                    <div>
                        <h3><a href="#3"><label id="WFALabel">Work Flow Action</label></a></h3>
                        <div id="thirdContent">
                    ...
                    -->
                    <div>
                        <h3><a href="#2">Agent To Do List</a></h3>
        ...
        <div id="innerContent"><!-- INNER -->
            ...
            <div id="leftContent"><!-- LEFT CONTENT -->
				<div id="extractHelpContainer">
                    ...
                    <div>
                    	<div id="helpPos">
                           <span> <a class="mainHelp" href="index.php">Return to ISYS Search</a></span>	
                        </div>
                     
                    </div>
            	</div>
				<iframe id="isys" src="consultant_include/consultantpage.php"></iframe>
